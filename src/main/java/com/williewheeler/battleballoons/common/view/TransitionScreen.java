...
public class TransitionScreen extends AbstractScreen {
	...
	public static TransitionScreen create(String name, BBConfig config, BBViewContext context) {
		TransitionScreen screen = new TransitionScreen(name, config, context);
		screen.postConstruct();
		return screen;
	}

	private TransitionScreen(String name, BBConfig config, BBViewContext context) {
		super(name, config, context);
		int schemeIndex = RandomUtil.nextRandomInt(COLOR_SCHEMES.length);
